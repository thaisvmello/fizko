      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-4">
              <div className="space-y-2 text-sm font-montserrat text-muted-foreground">
                <p>📧 <a href="mailto:contato@fisko.com.br?subject=Fizko%20-%20Suporte&body=" className="hover:text-fizko-coral transition-colors">contato@fisko.com.br</a></p>
        ...
        <div className="border-t border-fisko-blue/10 mt-8 pt-8 text-center">
          <p className="text-muted-foreground font-montserrat text-sm">
            © 2024 FIZK.O. Todos os direitos reservados. Simplificando soluções fiscais para empresas brasileiras.
          </p>
        </div>
      </div>
    </footer>
